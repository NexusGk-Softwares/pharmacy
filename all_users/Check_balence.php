          ...
          <div class="MIDDLE" style="height: 612px;">
                        ...
                        tr:nth-child(even) {
                         ...
                         <article style="width:940px;margin:0px auto;">
                                        ...
                                        <form method="GET" action="blance_search.php" style="float: right;">
                                         ...
                                         <div style="overflow-x:auto;">
                                          <a href = "Check_balence_pdf.php"><button style="float: right;margin-bottom: 10px;padding: 15px;color:green;">DOWNLOD</button></a>
                                            <table>
                               ...
                               <tr>
                                   ...
                                   <td><?php echo $rec['Doctor_Cost']; ?></td>
                                   <td><?php echo $rec['Room_Cost']; ?></td>
                                   <td><?php echo $rec['Medicine_Cost']; ?></td>
                                   <td><?php echo $rec['Extra_Cost']; ?></td>
