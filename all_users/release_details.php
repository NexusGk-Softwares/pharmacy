...
<?php 
  ...
  $qry=$obj->view_patient_release_paper();
                        ...
                        tr:nth-child(even) {
                         ...
                         <article style="width:940px;margin:0px auto;">
                                        ...
                                        <form method="GET" action="search.php" style="float: right;">
                                         ...
                                         <center> <h1>RELASE DETAILS</h1></center>
                                         <div style="overflow-x:auto;">
                                           <a href = "release_details_pdf.php"><button style="float: right;margin-bottom: 10px;padding: 15px;color:green;">DOWNLOD</button></a>
                                            <table>
                               ...
                               <tr>
                                   ...
                                   <td><?php echo $rec['release_time']; ?></td>
                                   ...
                                   <td><?php echo $rec['Permition_result']; ?></td>
